    ...
    iPanorama.prototype = {
        ...
        applyPitchLimits: function(sceneId) {
            ...
            if(this.config.pitchLimits) {
                if(this.config.pitchLimitsTop > -90 && this.config.pitchLimitsTop < 90) {
                    this.pitch.max = this.config.pitchLimitsTop;
                }
                if(this.config.pitchLimitsBottom > -90 && this.config.pitchLimitsBottom < 90) {
                    this.pitch.min = this.config.pitchLimitsBottom;
                }
            }
        },
